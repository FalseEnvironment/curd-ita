...
func TestConfiguredProviderNamesAcceptsOrderedLists(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "empty", cfg: &CurdConfig{}, want: []string{"animeworld", "senshi", "anipub", "anineko", "allanime", "animepahe"}},
		...
		{name: "legacy alias", cfg: &CurdConfig{Provider: "stacked"}, want: []string{"animeworld", "senshi", "anipub", "anineko", "allanime", "animepahe"}},
	}
